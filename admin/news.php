        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="upload_news.php">
                    ...
                    <div class="form-group">
                        <label>News</label>
                        <input name="content" type="text" placeholder="content" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>URL</label>
                        <input name="url" type="text" placeholder="content" class="form-control" required>
                    </div>
...
<div class="d-flex align-items-stretch">
    <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            ...
            <li class="sidebar-list-item"><a href="#" class="sidebar-link text-muted "><i class="o-survey-1 mr-3 text-gray"></i><span>Scrolling News</span></a></li>
            ...
            <li class="sidebar-list-item"><a href="#" class="sidebar-link text-muted active"><i class="o-survey-1 mr-3 text-gray"></i><span>News and Updates</span></a></li>
    ...
    <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container-fluid px-xl-5">
            <section class="py-5">
                <div class="row m-3">
                    <div class="col-md-9"><h3>News and Updates</h3></div>
                    <div class="col-md-3">                <button type="button" data-toggle="modal" data-target="#exampleModal" class="btn btn-primary">Add News</button>
                    </div>
                ...
                <div class="row">
                    ...
                    while($row = $result1->fetch_assoc()) {
                        $news =  '<div class="col-lg-12"><a href="#" class="message card px-5 py-3 mb-4 bg-hover-gradient-primary no-anchor-style">
                          <div class="row">
                              <div class="col-lg-2 d-flex align-items-center flex-column flex-lg-row text-center text-md-left"><div class="bg-gray-100 roundy px-4 py-1 mr-0 mr-lg-3 mt-2 mt-lg-0 text-dark exclode" style="font-size: 80%">'.$row['date'].'</div>

                              </div>
                              <div class="col-lg-9 d-flex align-items-center flex-column flex-lg-row text-center">

                                  <p class="mb-0 mt-3 mt-lg-0 lead">'.$row['news'].'</p>
                                  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                  <p class="mb-0 mt-2 mt-lg-0 ">'.$row['url'].'</p>
                              </div>
                              <div class="col-lg-1 d-flex align-items-center flex-column flex-lg-row text-center text-md-left">
